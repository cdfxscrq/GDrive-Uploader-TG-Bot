...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '2010821234:AAF0GqqN2Dpj5k_yrCR4UIXMJHY0QPc3_LY' # Get it from https://t.me/BotFather
    APP_ID = '8860205' # Get it from my.telegram.org/apps
    API_HASH = 'c3cd9efdd1462c770146c5bbe13e37cb' # Get it from my.telegram.org/apps
